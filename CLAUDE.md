...
| Pi | `KioskPiDiningRoom` | `192.168.1.156` | — | — | Dining room kiosk — HA label: "Front Door" (`kiosk-front-door`) |
| Pi | `KioskPiFamilyRoom` | `192.168.1.157` | — | — | Family room kiosk — HA label: "Family Room" (`kiosk-family-room`) |
